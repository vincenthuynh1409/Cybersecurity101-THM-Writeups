...
Q1) Consider _p_ = 29, _g_ = 5, _a_ = 12. What is _A_?

**ANSWER:**

Q2) Consider _p_ = 29, _g_ = 5, _b_ = 17. What is _B_?

**ANSWER:**

Q3) Knowing that _p_ = 29, _a_ = 12, and you have _B_ from the second question, what is the key calculated by Bob? (key = _B__a_ mod _p_)

**ANSWER:**

Q4) Knowing that _p_ = 29, _b_ = 17, and you have _A_ from the first question, what is the key calculated by Alice? (key = _A__b_ mod _p_)
...
![An example of signing a message: Bob encrypts a message with his private key and Alice decrypts it with Bob's public key.](https://cdn-images.tryhackme.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/5f04259cf9bf5b57aed2c476-1725294344472.svg)  
...
Let’s say you have a website and want to use HTTPS. This step requires having a TLS certificate. You can get one from the various certificate authorities for an annual fee. Furthermore, you can get your own TLS certificates for domains you own using [Let's Encrypt(opens in new tab)](https://letsencrypt.org/) for free. If you run a website, it’s worth setting up and switching to HTTPS, as any modern website would do.
